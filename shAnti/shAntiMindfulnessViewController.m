//
//  shAntiMindfulnessViewController.m
//  shAnti
//
...
@interface shAntiMindfulnessViewController ()

@end

@implementation shAntiMindfulnessViewController
...
- (IBAction)indexDidChangeForSegmentedControl:(UISegmentedControl*)segmentedControl {
    ...
    if (index == 0) {
        shAntiMeditateViewController *meditateViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"MeditateViewController"];
        NSArray * theViewControllers = [NSArray arrayWithObject:meditateViewController];
